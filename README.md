...
Tarjeta de presentación con HTML5 semántico, estilos CSS y una pequeña interacción en JavaScript.

## Sitio publicado

Disponible en GitHub Pages: `https://alexjoelrg27.github.io/Ejercicios-semana-1/`
...
Si todas las pruebas pasan, se publica la carpeta `ejercicio1/` en **GitHub Pages**.
